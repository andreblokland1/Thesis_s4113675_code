...
create_dbase_and_templates.R — reads BA23-25.xlsx and writes the .rds
data objects used by the simulation.
run_simulation_parallel.R — runs the Monte Carlo simulation and writes
pc_results_<n>sim_<timestamp>.rds.
script_section5_results_analysis_clean.R — produces the tables and
figures for Chapter 5.
analyse_hypotheses.R — evaluates hypotheses H1–H3.
